...
- Everything inside the views folde and outside any other dir(inside the views folder) will replace the '{{{body}}}' placeholder depending upon the GET request.
...
Also 'views' need to be in the project dir bcz express automatically looks for views in the project dir.